...
export function CareersPage() {
    ...
    const validateForm = (): boolean => {
        ...
        else if (formData.cover_letter.length < 50) newErrors.cover_letter = 'Cover letter must be at least 50 characters';
    ...
    const handleSubmit = async () => {
        if (!selectedCareer || !validateForm()) return;
                            ...
                            {submitted ? (
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-4 py-2.5 bg-slate-50 dark:bg-secondary-dark border rounded-xl text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-primary focus:border-transparent transition-all ${errors.full_name ? 'border-red-500' : 'border-slate-200 dark:border-gray-700'}`}
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-4 py-2.5 bg-slate-50 dark:bg-secondary-dark border rounded-xl text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-primary focus:border-transparent transition-all ${errors.email ? 'border-red-500' : 'border-slate-200 dark:border-gray-700'}`}
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-4 py-2.5 bg-slate-50 dark:bg-secondary-dark border rounded-xl text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-primary focus:border-transparent transition-all ${errors.phone ? 'border-red-500' : 'border-slate-200 dark:border-gray-700'}`}
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full px-4 py-2.5 bg-slate-50 dark:bg-secondary-dark border border-slate-200 dark:border-gray-700 rounded-xl text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div
                                            className={`relative border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-all ${dragActive
                                            ...
                                            {resume ? (
                                                <div className="flex items-center justify-center gap-3">
                                                    ...
                                                    <div className="text-left">
                                                        <p className="text-slate-800 dark:text-white font-medium text-sm">{resume.name}</p>
                                                    ...
                                                    <button
                                                        ...
                                                        className="ml-2 text-slate-400 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400"
                                                    >
                                                        <X size={18} />
                                                    </button>
                                                </div>
                                                ...
                                                <div className="flex items-center justify-center gap-3">
                                                    <Upload className={`${dragActive ? 'text-primary' : 'text-slate-400 dark:text-gray-500'}`} size={24} />
                                                    <div className="text-left">
                                                        <p className="text-slate-700 dark:text-white font-medium text-sm">
                                    ...
                                    <div>
                                        <div className="flex items-center justify-between mb-1.5">
                                            ...
                                            <span className={`text-xs ${formData.cover_letter.length < 50 ? 'text-slate-500 dark:text-gray-500' : 'text-accent-green'}`}>
                                                {formData.cover_letter.length} / 50 min
                                            </span>
                                        </div>
                                        <textarea
                                    ...
                                    {errors.submit && (
                                        <div className="flex items-center gap-2 p-3 bg-red-500/10 border border-red-500/30 rounded-lg text-red-500 dark:text-red-400 text-sm">
                                            <AlertCircle size={16} />
                                            {errors.submit}
                                        </div>
                                    )}
